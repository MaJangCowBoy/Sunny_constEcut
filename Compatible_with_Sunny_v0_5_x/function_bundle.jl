...
function define_qgrid(cryst,axis1,axis2,N1,N2)
  ...
  qgrid = [Float64[] for i in 1:N1, j in 1:N2] 
  for i in 1:N1, j in 1:N2
    qgrid[i,j] = [1/3, 0, 1] .+ range1[i] * axis1 + range2[j] * axis2;
  end
...
function define_qline(cryst,axis1,axis2,N1,N2)
  ...
  qpath1 = [];  for x in range1  push!(qpath1, [1/3, 0, 1] .+ x * axis1 );  end
  # qpath1 = q_space_path(cryst, qline1, N1);
  qpath2 = [];  for y in range2  push!(qpath2, [1/3, 0, 1] .+ y * axis2 );  end
